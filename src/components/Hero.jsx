        ...
        <h1 className="special-font hero-heading absolute bottom-5 right-5 z-40 text-[#e9311a]">
                ...
                <div className="absolute left-2 top-0 z-40 size-full ">
                    <div className="mt-1 left-2 px-5 sm:px-10">
                        ...
                        <Button id="watch-trailer" title="Know More" leftIcon={<TiLocationArrow/>} containerClass="bg-yellow-300 flex-center gap-1"/>
                    </div>
                </div>
            </div>
            <h1 className="special-font hero-heading absolute bottom-5 right-5  text-yellow-500">
                   L <b>C</b> S
                </h1>
        </div>
  );
